    ...
    <div class="header-inner wrapper">
        ...
        <div class="header-links">
            ...
            <div class="header-btns">
                ...
                <a href="{{route('create_resume')}}"><button class="btn-blue font-white-16px btn-create-resume">Создать резюме</button></a>
                <a href="{{route('registration')}}" style="text-align: center"><button class="btn-white font-blue-16px">Войти</button></a>
            </div>
        </div>
    </div>
</header>